...
#     time.sleep(0.2)
#     send_data(ser, "#1 P1300 S750 #5 P1300 S750 #9 P650 S750 #17 P1700 S750 #21 P1600 S750 #25 P1700 S750\n\r") #keskel seishoiak
#     time.sleep(0.2)
#     send_data(ser, "#2 P1100 S750 #6 P1100 S750 #10 P1100 S750 #18 P1900 S750 #22 P1900 S750 #26 P1900 S750\n\r")
#     time.sleep(0.2)
#     send_data(ser, "#8 P1500 S750 #24 P1500 S750 #16 P1400 S750 #20 P1500 S750 #0 P1500 S750 #4 P1500 S750\n\r")
#     
    time.sleep(0.2)
    send_data(ser, "#1 P1150 S750 #5 P1150 S750 #9 P550 S750 #17 P1850 S750 #21 P1750 S750 #25 P1850 S750\n\r") #keskel seishoiak
    time.sleep(0.2)
    send_data(ser, "#2 P1100 S750 #6 P1100 S750 #10 P1100 S750 #18 P1900 S750 #22 P1900 S750 #26 P1900 S750\n\r")
    time.sleep(0.2)
    send_data(ser, "#8 P1500 S750 #24 P1500 S750 #16 P1400 S750 #20 P1500 S750 #0 P1500 S750 #4 P1500 S750\n\r")
    ...
    time.sleep(2.1)
#     send_data(ser, "#21 P1450 #17 P1550 #1 P850 #5 P850 T500\n\r") HEXA EI SAA CRAB RAVEIDA
#     time.sleep(0.6)
#     send_data(ser, "#21 P1750 #17 P1850 #1 P1150 #5 P1150 T500\n\r")
#     time.sleep(0.6)
#tantsurutiin2
